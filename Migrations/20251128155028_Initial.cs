    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "CategoryColor", "CategoryDescription", "CategoryName" },
                values: new object[,]
                {
                    { 1, "#FF0000", "Study Backend", "Study" },
                    { 2, "#00FF00", "Work Work", "Work" },
                    { 3, "#0000FF", "Relax", "Fun" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, true, "learn" });
